...
public class PlaneDetector : MonoBehaviour
{
    ...
    public void Update()
    {   
        if(ObjectSpawner.restart){
            // After restart, get all the existing plane
            NRFrame.GetTrackables<NRTrackablePlane>(m_NewPlanes, NRTrackableQueryFilter.All);
            Debug.Log("generate all plane");
            ObjectSpawner.restart = false;
        }
        else{
